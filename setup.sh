...
echo "2. Train the model: jupyter notebook FER2013_Improved.ipynb"
echo "3. Run the web app: streamlit run emotion_detection_app.py"
echo "4. Or start the API: python api.py"
echo ""
